...
- (void)setHeader:(ZSDRefreshHeadView *)header {
    ...
    objc_setAssociatedObject(self, &ZSDRefreshHeaderViewKey,header,OBJC_ASSOCIATION_ASSIGN);
...
- (void)setFooter:(ZSDRefreshFootView *)footer {
    ...
    objc_setAssociatedObject(self, &ZSDRefreshFooterViewKey,footer,OBJC_ASSOCIATION_ASSIGN);
