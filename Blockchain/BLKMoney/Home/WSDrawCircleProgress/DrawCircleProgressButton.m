...
- (UIBezierPath *)bezierPath {
    ...
    if (!_bezierPath) {
        ...
        _bezierPath = [UIBezierPath bezierPathWithArcCenter:centerPoint radius:radius
                    startAngle:degreesToRadians(-90) endAngle:degreesToRadians(270) clockwise:YES];
    }
    return _bezierPath;
}
...
- (CAShapeLayer *)trackLayer {
    ...
    if (!_trackLayer) {
        ...
        UIColor *fill_color = [UIColor colorWithRed:0.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:0.3];
        _trackLayer.fillColor = self.fillColor.CGColor ? self.fillColor.CGColor : fill_color.CGColor;
