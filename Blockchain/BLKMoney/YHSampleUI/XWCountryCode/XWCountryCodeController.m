...
#define LanguageIsEnglish [[[NSUserDefaults standardUserDefaults] valueForKey:@"userLanguage"] isEqualToString:@"en"] //([CURR_LANG isEqualToString:@"en-US"] || [CURR_LANG isEqualToString:@"en-CA"] || [CURR_LANG isEqualToString:@"en-GB"] || [CURR_LANG isEqualToString:@"en-CN"] || [CURR_LANG isEqualToString:@"en"])
...
- (void)viewDidLoad {
    ...
    //顶部标题
    [self.navigationItem setTitle:YHBunldeLocalString(@"yh_country_area", [FGLanguageTool userbundle])];
